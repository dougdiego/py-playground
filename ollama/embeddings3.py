...
# Get a list of all markdown files in the 'data/pj' directory
markdown_files = glob.glob('data/pj/*.md')

docs = []

# Loop through the list of markdown files
for file in markdown_files:
    # Create an UnstructuredMarkdownLoader for the file
    loader = UnstructuredMarkdownLoader(file)
    # Load and split the file, and add the result to the 'docs' list
